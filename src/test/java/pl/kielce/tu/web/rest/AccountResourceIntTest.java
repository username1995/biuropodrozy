package pl.kielce.tu.web.rest;

import pl.kielce.tu.BiuropodrozyApp;
import pl.kielce.tu.config.Constants;
import pl.kielce.tu.domain.Authority;
import pl.kielce.tu.domain.PersistentToken;
import pl.kielce.tu.domain.User;
import pl.kielce.tu.repository.AuthorityRepository;
import pl.kielce.tu.repository.PersistentTokenRepository;
import pl.kielce.tu.repository.UserRepository;
import pl.kielce.tu.security.AuthoritiesConstants;
import pl.kielce.tu.service.MailService;
import pl.kielce.tu.service.UserService;
import pl.kielce.tu.service.dto.PasswordChangeDTO;
import pl.kielce.tu.service.dto.UserDTO;
import pl.kielce.tu.web.rest.errors.ExceptionTranslator;
import pl.kielce.tu.web.rest.vm.KeyAndPasswordVM;
import pl.kielce.tu.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = BiuropodrozyApp.class)
